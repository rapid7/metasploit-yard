Feature: yard.rake
  ...
  Scenario: Without Rails
    ...
    And I successfully run `bundle gem without_rails_use_metasploit_yard --test=rspec` for up to 20 seconds
  ...
  Scenario: With a Rails Application
    ...
    And I successfully run `rails new rails_application_use_metasploit_yard --skip-action-view --skip-active-record --skip-javascript --skip-spring --skip-sprockets --skip-test-unit` for up to 20 seconds
